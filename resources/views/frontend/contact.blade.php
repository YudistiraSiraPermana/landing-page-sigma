...
@section('content')
<section id="blog" class="blog-area pt-20">
  <div class="container">
      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li>
          <div class="flex items-center">
            ...
            <a href="/contact"
              class="ml-1 text-sm font-medium text-violet-500 hover:text-violet-950 md:ml-2 dark:text-violet-950 dark:hover:text-violet-950">Contact</a>
          </div>
        </li>
      </ol>
    </nav>
...
<center>
  ...
  <form class="w-full max-w-lg" method="POST" action="contact/send">
    ...
    <div class="md:flex md:items-center">
      <div class="md:w-1/3">
        <button
          class="shadow bg-violet-500 hover:bg-violet-950  focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded w-full"
          type="submit">
          Send
        </button>
      </div>

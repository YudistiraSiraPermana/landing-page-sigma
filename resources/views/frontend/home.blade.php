  ...
  <div class="container">
    <div class="justify-center row">
      <div class="w-full lg:w-2/3">
        <div class="pt-20 mb-12 text-center lg:pt-20 header-hero-content">
          <h2 class="
                    mb-3
                    text-4xl
                    font-bold
          ...
          <a href="#features"
            class="page-scroll bg-violet-500 hover:bg-violet-950 text-white font-bold py-2 px-4 rounded wow fadeInUp"
            data-wow-duration="1.3s" data-wow-delay="1.1s">Click Here</a>
        </div>
        <!-- header hero content -->
      </div>
    </div>
...
<div class="pt-10 brand-area">
  ...
  <section id="features" class="services-area pt-5">
    <div class="container">
      <div class="justify-center row">
        <div class="w-full lg:w-2/3">
          <div class="pb-5 text-center section-title">
            <div class="m-auto line"></div>
            <h3 class="title">Program Studi<span></span></h3>
          </div> <!-- section title -->
        </div>
      </div> <!-- row -->
      <div class="justify-center row ">
  ...
  <section id="about" class="relative pt-15 about-area">
    <div class="container">
      <div class="row">
  ...
  <footer id="footer" class="relative z-10 footer-area pt-10">

...
<section id="team" class="team-area pt-20">
  <div class="container">
    ...
    <nav class="flex mb-10" aria-label="Breadcrumb">
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        <li class="inline-flex items-center">
          <a href="/"
            class="inline-flex items-center text-sm text-violet-500 hover:text-violet-950 dark:-violet-950 dark:hover:text-violet-950">
        ...
        <li>
          <div class="flex items-center">
            ...
            <a href="/gallery"
              class="ml-1 text-sm font-medium text-violet-500 hover:text-violet-950 md:ml-2 dark:text-violet-950 dark:hover:text-violet-950">Gallery</a>
          </div>
        </li>
      </ol>
    </nav>
    ...
    <div class="justify-center row">
      <div class="w-full lg:w-2/3">
        <div class="pb-8 text-center section-title">
          ...
          <span class="mt-4"><a href="/gallery" class="text-violet-500 btn">Photos</a> | <a href="/gallery/videos"
              class="text-violet-500 font-bold ">Videos</a> </span>
        </div>
    ...
    <div class="justify-center row">
      ...
      <div class="w-full sm:w-2/3 lg:w-1/3">
        <div class="mt-4 text-center single-team wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
